    ...
    <div className="min-h-screen text-white">
      ...
      <section className="bg-[#1B201A] container mx-auto px-8 py-20">
        ...
        <p className="text-center text-gray-300 mb-12 max-w-3xl mx-auto">
          The SIFT platform eliminates manual research and delivers the precise
          intelligence your sales team needs to personalize pitches and
          ...
          <div className="flex items-center justify-center gap-12">
            ...
            <div className="max-w-md">
              ...
              <p className="text-gray-300">
                Simply input the name of any potential client company &
                prospects it on-demand. Our system processes thousands of data
                points—from recent news, financials, competitors, tech stacks—to
                give instant in-person, eliminating hours of manual research.
              </p>
            </div>
          </div>
